...
def korean():
    ...
    def inputword():
        ...
        koreanw()
    koreanl = tk.StringVar()
    engl = tk.StringVar()
    # Labels
    ET = tk.Label(english, text = "Words:")
    kol = tk.Label(english, textvariable=koreanl)
    enl = tk.Label(english, textvariable=engl)

    # Entry Widget
    E = tk.Entry(english)
    # Buttons
    EN = tk.Button(english, text="Enter", command= inputword)
    B = tk.Button(english, text="Back", command=english.destroy)
